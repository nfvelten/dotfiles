...
Item {
  ...
  readonly property int floatingEdgeGap: Style.space(8)
  readonly property int floatingSideGap: Style.space(4)
  readonly property int floatingPanelExtent: barSize + floatingEdgeGap
  readonly property int floatingRadius: Math.min(Style.space(10), Math.max(0, root.barSize / 2))
  ...
  component BarPanel: PanelWindow {
    ...
    margins {
      top: root.barHidden && root.position === "top" ? -root.floatingPanelExtent : (root.vertical ? root.floatingSideGap : 0)
      bottom: root.barHidden && root.position === "bottom" ? -root.floatingPanelExtent : (root.vertical ? root.floatingSideGap : 0)
      left: root.barHidden && root.position === "left" ? -root.floatingPanelExtent : (!root.vertical ? root.floatingSideGap : 0)
      right: root.barHidden && root.position === "right" ? -root.floatingPanelExtent : (!root.vertical ? root.floatingSideGap : 0)
    }
    ...
    implicitWidth: root.vertical ? root.floatingPanelExtent : 0
    implicitHeight: root.vertical ? 0 : root.floatingPanelExtent
    color: "transparent"
    ...
    Item {
      ...
      x: root.position === "left" ? root.floatingEdgeGap : 0
      y: root.position === "top" ? root.floatingEdgeGap : 0
      ...
      BorderSurface {
        ...
        borderSpec: root.transparent ? Border.none() : Border.flat(Style.normalBorderFor(root.barForeground, Color.accent, Color.urgent), 1)
        radius: root.floatingRadius
      }
